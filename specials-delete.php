...
<html>
	...
	<body>
		<?php 
			...
			$SQLcmd = "DELETE FROM specials where name='$name'";
		...
		<div class="row pt-5 mb-5">
			...
			<div class="card col-md-3 mx-auto shadow">
				...
				<div class="card-body">
					...
					<?php
						if ($sucess === true) {
							?><div class="alert alert-success" role="alert">Special Deleted</div><?php
						}
						else {
							?><div class="alert alert-danger" role="alert">Special Deletion Failed</div><?php
						}
					?>
				</div>
			</div>
