		...
		<?php
			...
			if( $_SERVER['REQUEST_METHOD'] === 'POST') {
				if ( isset( $_POST['cancel'] ) ) {
					$SQLcmd = "DELETE FROM events WHERE id=$id";
				...
				<div class="card-body">
					...
					<?php
						if ($updateComplete === true) {
							?><div class="alert alert-success" role="alert">Event Cancelled</div><?php
						}
						else if ($updateComplete === false) {
							?><div class="alert alert-danger" role="alert">Event Failed to Cancel</div><?php
						}
					?>
				</div>
			</div>
