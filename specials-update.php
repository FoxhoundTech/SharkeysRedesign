...
<html>
	...
	<body>
		<?php 
			...
			$sqlStmt = "UPDATE specials set type='$type', price=$price, description='$description', url='$url' where name='$name'";
		...
		<div class="row pt-5 mb-5">
			...
			<div class="card col-md-3 mx-auto shadow">
				...
				<div class="card-body">
					...
					<?php
						if ($sucess === true) {
							?><div class="alert alert-success" role="alert">Special Updated</div><?php
						}
						else {
							?><div class="alert alert-danger" role="alert">Special Update Failed</div><?php
						}
					?>
				</div>
			</div>
