...
<html>
	...
	<body>
		<?php
			...
			$SQLcmd = "SELECT * FROM pendingEvents WHERE id='$id'";
		...
		<div class="card col-md-3 mx-auto shadow">
			...
			<div class="card-body">
				<form action="events-approve.php" method="post">
					<div class="form-group">
						...
						<div class="btn-group">
							<input class="form-control btn btn-primary mr-2" type="submit" id="approve" name="approve" value="Approve"/>
							<input class="form-control btn btn-primary" type="submit" id="decline" name="decline" value="Decline"/>
						</div>
						</div>
					</div>
				</form>
