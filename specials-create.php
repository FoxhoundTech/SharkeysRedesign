...
<html>
	...
	<body>
		<?php 
			...
			$name = mysqli_real_escape_string($connect, $_POST['specialName']);
			$type = mysqli_real_escape_string($connect, $_POST['specialType']);
			$price = mysqli_real_escape_string($connect, $_POST['specialPrice']);
			$url = mysqli_real_escape_string($connect, $_POST['specialURL']);
			$description = mysqli_real_escape_string($connect, $_POST['specialDescription']);
			
			$SQLcmd = "INSERT INTO specials (name, type, price, description, url) VALUES ('$name', '$type', '$price', '$description', '$url')";
		...
		<div class="row pt-5 mb-5">
			...
			<div class="card col-md-3 mx-auto shadow">
				...
				<div class="card-body">
					<form class="mb-2" action="specials-create.php" method="post">
					...
					<?php
						if ($sucess === true) {
							?><div class="alert alert-success" role="alert">Special Created</div><?php
						}
						else {
							?><div class="alert alert-danger" role="alert">Special Creation Failed</div><?php
						}
					?>
