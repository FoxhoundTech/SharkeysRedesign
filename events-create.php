...
<html>
	...
	<body>
		<?php 
			...
			$SQLcmd = "INSERT INTO events(contact, type, phone, date, email, guests, comments) VALUES ('$name', '$type', '$phone', '$date', '$email', '$guests', '$comments' )";
		...
		<div class="row pt-5">
			...
			<div class="card col-md-3 mx-auto shadow">
				...
				<div class="card-body">
					<form action='events-create.php' method='post'>
						...
						<div class="form-row justify-content-center">
							...
							<div class="form-group col-md">
								...
								<input type="text" class="form-control" id="inputDate" name="inputeDate" placeholder="Select Date" required>
							</div>
						</div>
						<div class="form-row justify-content-center">
							<div class="form-group col-md">
					...
					<?php
						if ($sucess === true) {
							?><div class="alert alert-success" role="alert">Event Created</div><?php
						}
						else if ($sucess !== true) {
							?><div class="alert alert-danger" role="alert">Event Creation Failed</div><?php
						}
					?>
				</div>
			</div>
